...
def check(directory="results/q1",workbook="results/result1.xlsx"):
    ...
    result = {"passed":True,"numeric_result_cells_checked":count,"workbook_sha256":sha256(workbook),"workbook_hash":file_record(workbook),"table_values_match":True,"figure_source_values_match":True,"sheets":["温度","水分浓度"],"range_per_sheet":"A1:V1801","rounding":"Decimal(str(float)); ROUND_HALF_UP; 4 decimal places","writer":"openpyxl normal mode","original_template_sha256":m["inputs"]["sha256"]["template"]}
