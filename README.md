...
| [第一问参考方案](reports/Q1_REFERENCE_PLAN.md) | 题面核查、传质闭合、潜热审查、径向离散与误差预算 | 第一问建模、编程和交叉核查成员 |
| [第一问建模提示词](prompts/Q1_MODELING_PROMPT.md) | 在真实Plan模式中继续正式建模论证，明确后续执行契约 | 第一问任务启动与衔接 |
